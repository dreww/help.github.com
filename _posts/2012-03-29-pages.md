...
![automatic page generator](ghpages_generator_button.png)

Author your content in the Markdown editor. After you've finished, click the **Continue To Layouts** button.

![select a theme](ghpages_themes.png)

Next, preview your styled content by browsing through our selection of themes. When you find a theme that you like, click publish and your page will be generated.
